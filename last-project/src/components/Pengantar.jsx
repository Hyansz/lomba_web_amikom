...
export default function Pengantar () {
    return (
        <div>
            <div className="hero lg:p-10 xl:px-20 bg-pink-500 sm:bg-red-500 md:bg-blue-500 lg:bg-green-500 xl:bg-purple-500 2xl:bg-orange-500">
                ...
                <div className="hero-text text-center md:text-md md:p-12 lg:text-left py-20 lg:p-0 w-11/12 lg:w-6/12 m-auto xl:w-7/12 2xl:w-9/12">
                    <div data-aos="zoom-in" data-aos-duration="1500">
                        <h1 className="font-bold text-3xl lg:text-3xl w-72 lg:w-full m-auto mb-1 md:text-4xl md:pb-5">Sejarah Wayang</h1>
